...
public class testPayee {
    ...
    public void testNewRecord() {
        ...
        try {
            ...
            poJSON = poGLControllers.Payee().getModel().setParticularID("0001");
            if ("error".equals((String) poJSON.get("result"))) {
                Assert.fail((String) poJSON.get("message"));
            }
            poJSON = poGLControllers.Payee().saveRecord();
            if ("error".equals((String) poJSON.get("result"))) {
                Assert.fail((String) poJSON.get("message"));
            }
    ...
    public void testUpdateRecord() {
        try {
            JSONObject poJSON;
            poJSON = poGLControllers.Payee().openRecord("24009");
            if ("error".equals((String) poJSON.get("result"))) {
                Assert.fail((String) poJSON.get("message"));
            }

            poJSON = poGLControllers.Payee().updateRecord();
            if ("error".equals((String) poJSON.get("result"))) {
                Assert.fail((String) poJSON.get("message"));
            }
            poJSON = poGLControllers.Payee().getModel().setPayeeName("CENPELCO");
            ...
            poJSON = poGLControllers.Payee().getModel().setModifyingId(oApp.getUserID());
            if ("error".equals((String) poJSON.get("result"))) {
                Assert.fail((String) poJSON.get("message"));
            }

            poJSON = poGLControllers.Payee().getModel().setModifiedDate(oApp.getServerDate());
            if ("error".equals((String) poJSON.get("result"))) {
                Assert.fail((String) poJSON.get("message"));
            }
